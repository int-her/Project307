...
function successCallback(position) {
	...
	var url = 'http://swopenapi.seoul.go.kr/api/subway/4we1Svife1ANzIwfRlMm4LIKHZI6BiBr2+8+TMz1QkiwBNUTmqJImecu2GHvh04mEAYTTgh60HoxSa+LdhW0+A==/xml/nearBy/0/5/197529.91541/450688.46452';
	rest.get(url, null, null,
		function(data, xhr) {
			var code = data.getElementsByTagName("code")[0].childNodes[0].nodeValue;
			if (code !== "INFO-000") {
