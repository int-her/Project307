var subwayStation = (function(){
	...
	function successCallback(position) {
		 ...
		 */
		rest.get('http://swopenapi.seoul.go.kr/api/subway/4we1Svife1ANzIwfRlMm4LIKHZI6BiBr2+8+TMz1QkiwBNUTmqJImecu2GHvh04mEAYTTgh60HoxSa+LdhW0+A==/xml/nearBy/0/9' + position.coords.longitude + position.coords.latitude,
				null,
				null, 
				function(data, xhr) {
					var code = data.getElementsByTagName("code")[0].childNodes[0].nodeValue;
